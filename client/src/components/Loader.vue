<template>
    <div class="absolute inset-0 bg-slate-200/60 flex flex-col justify-center items-center gap-4 animate-pulse">
        <div class="loader">
        ...
        <span class="text-xl uppecase font-lexend mt-6">{{ props.text }}</span>
    </div>
</template>
